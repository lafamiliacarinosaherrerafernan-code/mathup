...
SRC_DIR = next(d for d in (BASE / "documentos").iterdir() if d.is_dir() and d.name.startswith("2") and "ESO" in d.name) / "Temas mios"
OUT_DIR = BASE / "Infograf\u00edas 2\u00ba ESO"
PREVIEW_DIR = BASE / "_preview" / "infografias_2eso"

THEMES = [
    ("Z", "#168B8F", "1-N\u00fameros enteros"),
    ("\u221a", "#7257C8", "2-Potencias y ra\u00edces cuadradas"),
    ("a/b", "#2572C7", "3-Fracciones"),
    ("%", "#E3B700", "4-Proporcionalidad"),
    ("x", "#28A06A", "5-Expresiones algebraicas"),
    ("=", "#EF6B24", "6-Sistemas de ecuaciones"),
    ("geo", "#168B8F", "7-Figuras planas"),
    ("3D", "#7257C8", "8-Cuerpos geom\u00e9tricos"),
