...
SRC_DIR = next(d for d in (BASE / "documentos").iterdir() if "Mates II" in d.name and "2" in d.name)
OUT_DIR = BASE / "Infografías 2º Bachillerato Mates II"
PREVIEW_DIR = BASE / "_preview" / "infografias_mates_ii"

THEMES = [
    ("M", "#168B8F", "Matrices"),
    ("det", "#7257C8", "Determinantes"),
    ("S", "#2572C7", "Resolución de sistemas mediante determinantes"),
    ("v", "#28A06A", "Vectores en el espacio"),
    ("π", "#E3B700", "Planos y rectas en el espacio"),
    ("d", "#EF6B24", "Propiedades métricas"),
    ("lim", "#7257C8", "Límite de sucesiones y funciones"),
    ("C", "#168B8F", "Continuidad"),
