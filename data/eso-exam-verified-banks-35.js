(function () {
  ...
  const banks = {
    ...
    "4eso-a::sistemas de ecuaciones e inecuaciones": [
      q("4eso-a-sistemas-de-ecuaciones-e-inecuaciones-0700a2036207", eso4aSys, "3. Ejercicio: En un garaje hay 260 coches y motos y 920 ruedas. ¿Cuántos vehículos hay de cada tipo? Plantea y resuelve un sistema.", ["200 coches y 60 motos", "60 coches y 200 motos", "180 coches y 80 motos", "230 coches y 30 motos"], "Resolución:\n1. Sea c el número de coches y m el de motos. c+m=260.\n2. Las ruedas dan 4c+2m=920; dividiendo entre 2, 2c+m=460.\n3. Restamos la primera ecuación: c=200; entonces m=60.\nComprobación: 200+60=260 y 4·200+2·60=920.\nResultado final: 200 coches y 60 motos."),
